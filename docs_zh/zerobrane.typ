...
<使用-zerobrane-studio-调试-lua-脚本>
Defold 包含一个内置调试器，但也可以将免费开源的 Lua IDE #emph[ZeroBrane Studio] 作为外部调试器运行。要使用调试功能，需要安装 ZeroBrane Studio。该程序是跨平台的，可以在 macOS 和 Windows 上运行。
...
+ 右键点击 #emph[game.project]
+ 选择 在桌面中显示

#box(image("../docs/en/manuals/images/zerobrane/show_in_desktop.png"))

== 设置 ZeroBrane
<设置-zerobrane>
要设置 ZeroBrane，请选择 项目 ▸ 项目目录 ▸ 选择…：

#box(image("../docs/en/manuals/images/zerobrane/setup.png"))
...
#box(image("../docs/en/manuals/images/zerobrane/startdebug.png"))
...
#block[
调试仅在启动调试的 lua 上下文中启用。在 #emph[game.project] 中启用 "shared\_state" 意味着无论您从哪里启动，都可以调试整个应用程序。

]
#box(image("../docs/en/manuals/images/zerobrane/code.png"))
...
#box(image("../docs/en/manuals/images/zerobrane/otherrecommended.png"))

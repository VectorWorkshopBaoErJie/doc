...
#box(image("../docs/en/manuals/images/input/key_bindings.png"))
...
#box(image("../docs/en/manuals/images/input/text_bindings.png"))
...
#box(image("../docs/en/manuals/images/input/marked_text.png"))

...
项目可以在 项目设置中将库添加为项目依赖项。依赖项在项目打开时或任何时候从 #emph[项目] 菜单中选择 #emph[获取库] 选项时进行下载/更新。
...
这将在当前目录中创建一个服务器，在 `localhost:8000` 上提供文件。如果当前目录包含下载的依赖项，您可以将它们添加到您的 #emph[game.project] 文件中：

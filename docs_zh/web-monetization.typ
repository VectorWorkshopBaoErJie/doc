...
+ 玩家必须持有 #strong[Web Monetization Provider] 账户 - 玩家付款的账户.
+ 开发者必须持有 #strong[Web Monetization Wallet] 账户 - 开发者收款的账户.
+ 开发者必须在网页上放置 #strong[Payment Pointer] 其中包含需要付费才能得到的内容 - 支付点用来确定把款项发往哪个钱包.

=== 网页支付账户
<网页支付账户>
玩家必须持有网页支付提供商提供账户以便向游戏开发者付款:

#box(image("../docs/en/manuals/images/web-monetization/coil_logo.svg"))
...
#box(image("../docs/en/manuals/images/web-monetization/uphold_logo.svg"))

#box(image("../docs/en/manuals/images/web-monetization/gatehub_logo.svg"))
...
#box(image("../docs/en/manuals/images/web-monetization/web-monetization-template.png"))

下一步注册 网页钱包账户 然后在 #strong[game.project] 文件的 Web Monetization 部分将支付点与钱包挂接:

#box(image("../docs/en/manuals/images/web-monetization/payment-pointer.png"))
...
下一步将 网页支付原生扩展 作为 项目依赖库 加入. 打开 #strong[game.project] 文件, 找到 Project 部分的 Dependencies 项 加入:

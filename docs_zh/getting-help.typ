...
== 在论坛上报告问题
<在论坛上报告问题>
在我们的论坛上发布问题是讨论和获取帮助的好方法。根据您遇到的问题类型，在问题或错误类别中发帖。记得在提问之前先搜索您的问题/问题，因为可能已经有解决方案了。
...
#strong[日志（可选）：]
请提供来自引擎、编辑器或构建服务器的相关日志。了解日志存储位置请点击这里。
...
== 从编辑器报告问题
<从编辑器报告问题>
编辑器提供了一种方便的方式来报告问题。从编辑器中选择帮助-\>报告问题菜单选项来报告问题。

#box(image("../docs/en/manuals/images/getting_help/report_issue.png"))

选择此菜单选项将带您到GitHub上的问题跟踪器。提供日志文件、有关您操作系统的信息、复现问题的步骤、可能的变通方法等。
...
== 在Discord上讨论问题
<在discord上讨论问题>
如果您在使用Defold时遇到问题，可以尝试在Discord上提问。但是，我们建议将复杂问题和深入讨论发布在论坛上。另请注意，我们不接受通过Discord提交的错误报告。

...
#box(image("../docs/en/manuals/images/script-properties/component.png"))

在编辑器中的#emph[Outline]视图中选择脚本组件，属性会出现在#emph[Properties]视图中，允许您编辑它们：

#box(image("../docs/en/manuals/images/script-properties/properties.png"))
...
当定义资源属性时，它会像任何其他脚本属性一样显示在#emph[Properties]视图中，但作为文件/资源浏览器字段：

#box(image("../docs/en/manuals/images/script-properties/resource-properties.png"))
